...
const Hero = () => {
  ...
  // Clear search input when returning to home page
  useEffect(() => {
    ...
    <section className="bg-hero relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-7">
        ...
        <motion.form
          ...
          className="w-full max-w-xl bg-white rounded-2xl border border-gray-200 shadow-lg hover:shadow-xl focus-within:border-primary/40 focus-within:shadow-2xl focus-within:shadow-primary/10 transition-all duration-300 flex items-center p-1.5 gap-2"
        >

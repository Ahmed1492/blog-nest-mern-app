        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <div className="relative bg-gradient-to-br from-primary to-violet-600 rounded-3xl p-8 text-white">
                <h3 className="text-2xl font-bold mb-6">Why Choose BlogNest?</h3>
